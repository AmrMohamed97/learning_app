...
import 'package:talamiz_arina/features/reservation/success_pay_page.dart';
...
class PageRoutes {
  ...
  static final GoRouter router = GoRouter(
    ...
    routes: [
      ...
      // ---------------- assignReserveDateTimePage
      GoRoute(
        parentNavigatorKey: _rootNavigatorKey,
        name: PagesKeys.assignReserveDateTimePage,
        path: "/${PagesKeys.assignReserveDateTimePage}",
        pageBuilder: (context, state) => buildPageWithDefaultTransition<void>(
          context: context,
          state: state,
      ...
      GoRoute(
        parentNavigatorKey: _rootNavigatorKey,
        name: PagesKeys.successPayPage,
        path: "/${PagesKeys.successPayPage}",
        pageBuilder: (context, state) => buildPageWithDefaultTransition<void>(
          context: context,
          state: state,
          child: const SuccessPayPage(),
        ),
      ),
      // ---------------- notificationPage
      GoRoute(
