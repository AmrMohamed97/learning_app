...
class GroupClassesList extends StatefulWidget {
  const GroupClassesList({super.key});

  @override
  State<GroupClassesList> createState() => _GroupClassesListState();
}

class _GroupClassesListState extends State<GroupClassesList> {
