...
class TimetablePackagesList extends StatefulWidget {
  const TimetablePackagesList({super.key});

  @override
  State<TimetablePackagesList> createState() => _TimetablePackagesListState();
}

class _TimetablePackagesListState extends State<TimetablePackagesList> {
