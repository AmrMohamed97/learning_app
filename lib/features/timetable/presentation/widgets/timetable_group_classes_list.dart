...
class TimetableGroupClassesList extends StatefulWidget {
  const TimetableGroupClassesList({super.key});

  @override
  State<TimetableGroupClassesList> createState() => _TimetableGroupClassesListState();
}

class _TimetableGroupClassesListState extends State<TimetableGroupClassesList> {
