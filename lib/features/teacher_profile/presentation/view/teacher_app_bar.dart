...
class TeacherAppBar extends StatefulWidget {
  const TeacherAppBar({super.key, required this.video, required this.onFavorite});
  final String video;
  ...
  Widget build(BuildContext context) {
    return SliverAppBar(
      ...
      flexibleSpace: const FlexibleSpaceBar(
        ...
        background: SafeArea(
          bottom: false,
          child: UniversalVideoViewer(
            videoUrl: 'https://www.youtube.com/watch?v=aieYzMVnMvU',
          ),
          // Container(
          //   color: Theme.of(
          //     context,
